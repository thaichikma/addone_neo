/** @odoo-module **/
//odoo.define('report_excel.FieldDomainParam', function(require){ "use strict";
...
//export const FieldDomainParam = AbstractField.extend({
    /**
...
fieldRegistry.add('domain_param', FieldDomainParam);
//registry.category("fields").add("domain_param", FieldDomainParam);
//});
