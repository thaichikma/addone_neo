...
class XLSXStyles(models.AbstractModel):
    ...
    def get_openpyxl_styles(self):
        ...
        return {
            ...
            'border': {
                'thin': Border(left=Side(style='thin'), right=Side(style='thin'), top=Side(style='thin'),
                                 bottom=Side(style='thin')),
                'dotted': Border(left=Side(style='dotted'), right=Side(style='dotted'), top=Side(style='dotted'),
                                 bottom=Side(style='dotted')),
                'double': Border(left=Side(style='double'), right=Side(style='double'), top=Side(style='double'),
